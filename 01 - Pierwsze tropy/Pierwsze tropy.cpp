...
int check_set() {
	...
	int y; // Liczba powstających tropów w metodzie
	int max_x = 0; // Największa liczba tropów analizowanych w metodzie
	int max_diff = 0; // Największa rónica między liczbą analizowanych tropów a powstałych tropów
	std::cin >> n >> m;
